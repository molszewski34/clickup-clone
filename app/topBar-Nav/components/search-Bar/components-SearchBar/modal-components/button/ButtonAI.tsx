    ...
    <>
      <button className="flex items-center bg-gray-100 border border-gray-200 hover:bg-blue-50 bg-opacity-10 opacity-90 group px-3 -m-1 mb-0 rounded-md flow-hidden h-[34px] w-auto">
        <svg
          ...
          className="fill-gray-400 -ml-1 group-hover:fill-[url(#custom-gradient)]" // Class hover gradient
          width="16px"
        >
          <defs>
            <linearGradient
            ...
            >
              <stop
                offset="0%"
                style={{ stopColor: "#0880EA", stopOpacity: 1 }}
              />
              <stop
                offset="39%"
                style={{ stopColor: "#8920FE", stopOpacity: 1 }}
              />
              <stop
                offset="72%"
                style={{ stopColor: "#E93D82", stopOpacity: 1 }}
              />
              <stop
                offset="92%"
                style={{ stopColor: "#C62AB6", stopOpacity: 1 }}
              />
            </linearGradient>
          </defs>
