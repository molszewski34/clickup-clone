...
import FilterInput from "@/app/(dashboard)/_components/SubNavBar/FilterInput";
...
const FiltersBar = ({}: Props) => {
  ...
  return (
    <div
      className={` flex gap-1 items-center bg-white transition-all duration-500 ease-in-out overflow-hidden px-5`}
