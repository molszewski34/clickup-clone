...
export default function Setting() {
  ...
  const [Email, setEmail] = useState("jakub.king1998@gmail.com");
            ...
            <div className="mt-4">
              ...
              <div className="flex gap-2 px-[11px] items-center border rounded-lg border-gray-200 focus-within:border-blue-500 focus-within:ring focus-within:ring-blue-200">
                ...
                <input
                  ...
                  name=""
                  id=""
                  value={FullName} // Wartość pochodzi ze stanu
                  onChange={(e) => setFullName(e.target.value)} // Aktualizujemy stan przy zmianie wartości
            ...
            <div className="mt-4">
              ...
              <div className="flex gap-2 px-[11px] items-center border rounded-lg border-gray-200 focus-within:border-blue-500 focus-within:ring focus-within:ring-blue-200">
                ...
                <input
                  ...
                  name=""
                  id=""
                  value={Email} // Wartość pochodzi ze stanu
                  onChange={(e) => setEmail(e.target.value)} // Aktualizujemy stan przy zmianie wartości
